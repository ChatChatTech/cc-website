...
<a href="../index.html" class="logo"><span class="logo-icon"><img src="../chatchat-icon.svg" alt="ChatChat"></span><span class="logo-text">查特查特科技</span></a>
...
<div class="footer-brand"><div class="logo"><span class="logo-icon"><img src="../chatchat-icon.svg" alt="ChatChat"></span><span class="logo-text">查特查特科技</span></div></div>
